...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                'assert', 'async', '', 'break', 'continue', 'del', 'elif',
        ...
        'magicfuncs': [
            (words((
                ...
                '__and__', '__anext__', '____', '__bool__', '__bytes__',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                'assert', 'async', '', 'break', 'by', 'continue', 'ctypedef', 'del', 'elif',
